...
function ProposalComponent() {
  ...
  const handleVote = async (
    ...
    try {
      ...
      if (error) {
        setErrorMessage(
          'Your vote failed. This could be because you tried to vote again, or because the voting deadline has passed'
        );
    ...
    <div className='my-8 mx-auto max-w-2xl'>
      <div className='flex justify-center'>
        ...
        {proposalStatus === 'PENDING' && (
          <Spinner show={isFetchProposalStatusPending} delay={400}></Spinner>
        )}
